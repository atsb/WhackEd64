...
from whacked64 import utils
from whacked64.dehacked import statefilter
from whacked64.ui import editormixin, windows
from whacked64.ui.dialogs import statepreviewdialog
...
class WeaponsFrame(editormixin.EditorMixin, windows.WeaponsFrameBase):
    ...
    def weaponlist_resize(self, event):
        ...
        if self.WeaponList.GetColumnCount() > 1:
            ...
            self.WeaponList.SetColumnWidth(1, column_width)
