...
from whacked64 import settingshandler


# Application info.
APP_NAME = 'WhackEd64'
APP_SIMPLE_NAME = 'whacked64'
APP_VERSION = '1.2.4'
APP_BETA = False
...
class WhackEd64Settings(settingshandler.SettingsHandler):
    """
    Settings for WhackEd64.
    """
...
settings = WhackEd64Settings(SETTINGS_PATH)
